...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef MXA_M58ArcherPods_KineticAmmo => new AmmoDef
        {
            AmmoMagazine = "MXA_M58ArcherPods_KineticAmmo", //MXA_M58ArcherPods_KineticAmmo //Need to make this later
            AmmoRound = "Kinetic",
            ...
            {
                AmmoRound = "MXA_M58ArcherPods_KineticAccelStage",
                Fragments = 1,
                Degrees = 0,
                Reverse = false,
        ...
        private AmmoDef MXA_M58ArcherPods_KineticAccelStage => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "MXA_M58ArcherPods_KineticAccelStage",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            Fragment = new FragmentDef
            {
                AmmoRound = "MXA_M58ArcherPods_KineticStage",
                Fragments = 1,
                Degrees = 0,
                Reverse = false,
                DropVelocity = false, // fragments will not inherit velocity from parent.
        ...
        private AmmoDef MXA_M58ArcherPods_KineticStage => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "MXA_M58ArcherPods_KineticStage",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            Fragment = new FragmentDef
            {
                AmmoRound = "MXA_M58ArcherPods_KineticShrapnel",
                Fragments = 10,
                Degrees = 270,
                Reverse = false,
                DropVelocity = false, // fragments will not inherit velocity from parent.
            ...
            */
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    Damage = 120f,
                    Depth = .75f, // Max depth of AOE effect, in meters. 0=disabled, and AOE effect will reach to a depth of the radius value
                    MaxAbsorb = 0f, // Soft cutoff for damage, except for pooled falloff.  If pooled falloff, limits max damage per block.
                    Falloff = Curve, //.NoFalloff applies the same damage to all blocks in radius
                    // Linear drops evenly by distance from center out to max radius
                    // Curve drops off damage sharply as it approaches the max radius
        ...
        private AmmoDef MXA_M58ArcherPods_KineticShrapnel => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "MXA_M58ArcherPods_KineticShrapnel",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
